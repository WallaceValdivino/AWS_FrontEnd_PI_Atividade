...
export class ProfessoresService {
  private apiUrl = 'https://piatividade1.duckdns.org/teacher/';  // Nova URL da API
  private cursosUrl = 'https://piatividade1.duckdns.org/courses'; // Caso precise acessar cursos também
