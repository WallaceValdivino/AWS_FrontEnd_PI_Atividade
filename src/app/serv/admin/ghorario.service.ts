  ...
  export class GhorarioService {
    private apiUrl = 'https://piatividade1.duckdns.org/reservation/';
    private teachersUrl = 'https://piatividade1.duckdns.org/teacher/';
    private subjectsUrl = 'https://piatividade1.duckdns.org/subject/';
    private timesUrl = 'https://piatividade1.duckdns.org/time/';
    private roomsUrl = 'https://piatividade1.duckdns.org/rooms/';
    private coursesUrl = 'https://piatividade1.duckdns.org/course/';
